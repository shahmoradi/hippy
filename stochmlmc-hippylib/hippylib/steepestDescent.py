...
class SteepestDescent:
    ...
    def __init__(self, model, parameters = SteepestDescent_ParameterList()):
        ...
        Type `SteepestDescent_ParameterList().showMe()` for list of default parameters
    ...
    def solve(self,x):
        """
        Solve the constrained optimization problem with initial guess x = [u,a,p]. Note x will be overwritten
